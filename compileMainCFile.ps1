...
cl.exe main_windows.c lib\build\bin\mingwX64\debugShared\account_ledger_lib.lib /Fe:lib\build\bin\mingwX64\debugShared\main.exe /Fo:lib\build\bin\mingwX64\debugShared\main.obj
